...
public class EditByUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("<h2>Edit Your Details:</h2>");
        out.print("<form action='EditByUser2' method='post'>");
        out.print("<div class='form-group'><label for='id'>User ID:</label><input type='text' name='id' value='" + u.getId() + "'readonly></div>");
        out.print("<div class='form-group'><label for='name'>Name:</label><input type='text' name='name' value='" + u.getName() + "'></div>");
        out.print("<div class='form-group'><label for='email'>Email:</label><input type='text' name='email' value='" + email + "'readonly></div>");
